        ...
        <main className="flex-grow">
          ...
          <section className="py-12 bg-gradient-to-br from-primary to-[hsl(260,70%,50%)] text-primary-foreground">
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              <p className="mb-6 text-secondary-foreground text-white">Request a demo of our real-time eligibility platform or Contact Us to see how we can reduce your denial rate.</p>
