      ...
      <div className="min-h-screen bg-background text-foreground">
        ...
        <main>
              ...
              <div className="grid gap-10 xl:grid-cols-[1.2fr_0.8fr] items-start">
                ...
                <div className="relative z-10 rounded-[2rem] border border-white/10 bg-white/10 p-8 shadow-2xl backdrop-blur-xl sm:p-10">
                  <div className="mb-6 text-center">
                    <span className="inline-flex rounded-full bg-white/10 px-4 py-2 text-sm font-semibold uppercase tracking-[0.32em] text-white/90">Contact Us</span>
                  </div>
          ...
          <section className="py-16 bg-[#f4f6ff]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid gap-10 xl:grid-cols-[0.95fr_1.05fr] items-center rounded-[2rem] border border-slate-200 bg-white p-10 shadow-sm">
                <div>
