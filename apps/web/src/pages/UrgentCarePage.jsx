...
function UrgentCarePage() {
  const challenges = [
    'High patient volume billing',
    ...
    <>
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-grow">
          <section className="relative py-20 bg-[url('https://images.unsplash.com/photo-1584515933487-779824d29309?auto=format&fit=crop&w=1600&q=80')] bg-cover bg-center">
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <p className="text-xl text-white/90 leading-relaxed mb-8">
                  Specialized billing for urgent care centers handling high patient volumes. Our team manages the unique challenges of urgent care billing, from E/M coding to workers compensation claims.
                </p>
          ...
          <section className="py-20 bg-background">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                >
                  <h2 className="text-3xl font-bold mb-6 text-foreground">Urgent care billing challenges</h2>
                  <p className="text-muted-foreground leading-relaxed mb-8">
                    Urgent care centers face unique billing challenges due to high patient volumes and diverse payer mix:
                  </p>
                ...
                >
                  <h2 className="text-3xl font-bold mb-6 text-foreground">Our urgent care solutions</h2>
                  <p className="text-muted-foreground leading-relaxed mb-8">
                    TransMedex provides billing services designed for urgent care operations:
                  </p>
                  <div className="space-y-4">
          ...
          <section className="py-20 bg-gradient-to-br from-primary to-[hsl(210,100%,50%)] text-primary-foreground">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              <motion.div
                ...
                transition={{ duration: 0.5 }}
              >
                <h2 className="text-3xl md:text-4xl font-bold mb-6">Optimize your urgent care revenue</h2>
                <p className="text-xl mb-8 opacity-95 leading-relaxed">
                  Partner with billing specialists who understand urgent care operations and high-volume billing.
                </p>
